...
export default function NewApplicationPage() {
  ...
  // ── Load scheme fields when scheme is selected ───────────────────────────
  useEffect(() => {
    if (!scheme) return;
    let cancel = false;
    async function load() {
          ...
          <div>
            ...
            <div className={styles.summarySection}>
              ...
              <div className={styles.summaryRow}>
                ...
                <span className={styles.summaryValue}>{bankName} · {accountNumber}</span>
              </div>
              <div className={styles.summaryRow}>
                <span className={styles.summaryLabel}>Account Name</span>
                <span className={styles.summaryValue}>{bankResult?.account_name || "—"}</span>
              </div>
            </div>
