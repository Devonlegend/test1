...
const faqs = [
  {
    ...
    icon: FileText,
    color: "var(--mbo-forest)",
    bg: "var(--green-tint-bg)",
    border: "var(--green-tint-border)",
    items: [
  ...
  },
  {
    ...
    icon: ShieldCheck,
    color: "var(--blue-training)",
    bg: "var(--blue-tint-bg)",
    border: "var(--blue-tint-border)",
    items: [
  ...
  },
  {
    ...
    bg: "var(--amber-tint-bg)",
    border: "var(--amber-tint-border)",
    items: [
  ...
  },
  {
    ...
    icon: Wallet,
    color: "var(--purple-grant)",
    bg: "var(--purple-tint-bg)",
    border: "var(--purple-tint-border)",
    items: [
...
const contactInfo = [
  { icon: MapPin,  label: "Address",      value: "RMHCDT, Mbo LGA, Akwa Ibom State",       color: "var(--mbo-forest)", bg: "var(--green-tint-bg)", border: "var(--green-tint-border)" },
  { icon: Mail,    label: "Email",        value: "info@rmhcdt.org",                          color: "var(--blue-training)", bg: "var(--blue-tint-bg)", border: "var(--blue-tint-border)" },
  { icon: Phone,   label: "Phone",        value: "+234 070 1234 5678",                       color: "var(--amber-earth)", bg: "var(--amber-tint-bg)", border: "var(--amber-tint-border)" },
  { icon: Clock,   label: "Office Hours", value: "Mon – Fri, 8:00 AM – 5:00 PM WAT",        color: "var(--purple-grant)", bg: "var(--purple-tint-bg)", border: "var(--purple-tint-border)" },
];
