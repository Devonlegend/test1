...
function ReadField({ icon: Icon, label, value, dimmed }) {
  return (
    <div className={styles.field} style={dimmed ? { opacity: 0.4 } : {}}>
      ...
      <div className={styles.readValue}>{value || "â€”"}</div>
    </div>
  );
}
...
export default function ProfilePage() {
  ...
  // â”€â”€ PROFILE HANDLERS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      <div className={styles.card}>
        ...
        <div className={styles.form}>
          ...
          <div className={styles.row2}>
            ...
            <ReadField icon={Users}    label="Gender"        value={form.gender ? form.gender.charAt(0).toUpperCase() + form.gender.slice(1) : "â€”"} dimmed={editing} />
          </div>
