...
export default function DisqualificationRegisterPage() {
  ...
  // â”€â”€ FETCH â€” filter rejected from all applications â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
    let cancelled = false;
    async function load() {
      try {
  ...
  // scheme.award_type) â€” not flat fields. d.rejection_reason will be empty
            ...
            <div key={d.id} className={styles.tableRowData}>
              ...
              <div className={styles.tdScheme}>
                ...
                <div className={styles.schemeInfo}>
                  <span className={styles.schemeName}>{d.scheme?.name || "â€”"}</span>
                  <span
              ...
              {/* Rejection reason â€” will read "No reason recorded" for every
