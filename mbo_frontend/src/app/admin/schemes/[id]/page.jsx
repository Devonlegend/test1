...
export default function SchemeDetailPage() {
  ...
  // â”€â”€ REOPEN â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      <div className={styles.pageHeader}>
        <div className={styles.headerLeft}>
          ...
          <div>
            ...
            <p className={styles.sub}>{scheme.academic_year} Â· {category.label}</p>
          </div>
        </div>
            ...
            {editing ? (
              <div className={styles.editForm}>
                ...
                <div className={styles.twoCol}>
                  ...
                  <div className={styles.field}>
                    <label className={styles.fieldLabel}>Award Amount (â‚¦)</label>
                ...
                {/* Eligibility criteria â€” read from scheme.eligibility_criteria */}
              ...
              <div className={styles.infoGrid}>
                ...
                <InfoRow icon={Building2}    label="Provider"         value={scheme.provider?.name || "â€”"} />
                <InfoRow icon={CalendarRange} label="Cycle"           value={scheme.cycle?.name ? `${scheme.cycle.name} (${scheme.cycle.start_year}/${scheme.cycle.end_year})` : "â€”"} />
                ...
                <InfoRow icon={Users}        label="Total Slots"      value={`${scheme.remaining_slots ?? scheme.total_slots ?? "â€”"} remaining of ${scheme.total_slots ?? "â€”"}`} />
