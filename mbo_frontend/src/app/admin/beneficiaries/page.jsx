...
// Backend only returns full_name (no firstname/lastname split) â€” derive initials from it.
...
export default function BeneficiaryRegisterPage() {
  ...
  // â”€â”€ FETCH â€” filter approved from all applications â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
    let cancelled = false;
    async function load() {
      try {
  ...
  // (student.full_name / student.ward, scheme.name / scheme.award_type) â€”
  // not flat fields. student.email and student.lga are not returned by the
  // backend's StudentNestedSerializer yet, so those show as "â€”" until added.
  ...
  // â”€â”€ EXPORT â€” must come after filtered is declared â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            <div key={b.id} className={styles.tableRowData}>
              ...
              <div className={styles.tdScheme}>
                ...
                <div className={styles.schemeInfo}>
                  <span className={styles.schemeName}>{b.scheme?.name || "â€”"}</span>
                  <span
              ...
              {/* Ward â€” LGA not in this endpoint's response, removed for now */}
              <div className={styles.tdLocation}>
                <span className={styles.wardText}>{b.student?.ward || "â€”"}</span>
              </div>
                ...
                <div className={styles.tdBank}>
                  {b.details?.account_number ? (
                    <>
                      <span className={styles.lgaText}>{b.details.bank_name || "â€”"}</span>
