...
export default function AdminApplicationsPage() {
  ...
  // â”€â”€ FETCH (scheme overview, with 30s polling + focus refresh) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // Initial load â€” whichever view is active
  useEffect(() => {
  ...
  // â”€â”€ DERIVED COUNTS (flat view) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const counts = {
  ...
  // â”€â”€ SCHEME VIEW TOTALS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const schemeTotals = {
  ...
  return (
    <div className={styles.page}>
      ...
      {/* â•â•â•â•â•â•â•â• BY SCHEME VIEW â•â•â•â•â•â•â•â• */}
      {view === "scheme" && !error && (
        <>
          {/* SUMMARY STRIP */}
      ...
      {/* â•â•â•â•â•â•â•â• ALL APPLICATIONS VIEW â•â•â•â•â•â•â•â• */}
      {view === "all" && !error && (
        <>
          {/* SUMMARY STRIP */}
          <div className={styles.summaryStrip}>
                ...
                return (
                  ...
                  >
                    ...
                    <div className={styles.tdScheme}>
                      <span className={styles.schemeName}>{app.scheme?.name || "â€”"}</span>
