...
// â”€â”€ ENTITY TYPE CONFIG â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const entityConfig = {
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.card}>
        ...
        {/* EMPTY â€” endpoint exists but no logs yet */}
        ...
        {!loading && !error && filtered.map((log) => {
          ...
          return (
            <div key={log.id} className={styles.tableRowData}>
              ...
              {/* Action */}
              <span className={styles.tdAction}>{log.action || "â€”"}</span>
        ...
        {!loading && !error && logs.length > 0 && (
          <div className={styles.tableFooter}>
            Showing {filtered.length} of {logs.length} entries Â· Last 100 actions
          </div>
        )}
