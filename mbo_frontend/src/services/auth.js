...
export const otpSend = (body) => api.post('/auth/otp/send/', body)

export const otpVerify = (body) => api.post('/auth/otp/verify/', body)

export const otpResend = (body) => api.post('/auth/otp/resend/', body)
